...
$md_client .= "	
		...
		if($input_data and $_GET["mode2"] == "normal")//090105
			...
			{
			$md_client .= "<input type='text' name='client_name' value='".$clean['client_name'].$af_TABLE4['client_name']."' onblur='quot_Del(this)' class='ess' style='ime-mode:active;'>";
			}
$md_client .= "	
		</td>
		$c1_trEnd
...
$md_client_memo = "
		...
		if($input_data and $_GET["mode2"] == "normal")//090105
			...
			{
			$md_client_memo .= "
			<textarea name='client_memo' id='client_memo' style='width:100%;ime-mode:active;' rows='7' onblur='quot_Del(this)'>".$clean['client_memo'].$af_TABLE4['client_memo']."</textarea>";
			}
$md_client_memo .= "
		</td>
		</tr>				
