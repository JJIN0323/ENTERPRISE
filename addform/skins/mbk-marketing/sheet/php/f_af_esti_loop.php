...
function f_af_esti_loop()
{
	...
	<tr>
		<!-- 번 호  -->
        <td style='width:7%;text-align: center;border:1px solid #000000;padding:3px 3px 3px 3px;'>
            $number
        </td>
		<!-- 품 목  -->
        <td style='text-align:left;border:1px solid #000000;padding:3px 3px 3px 3px;'>
            $it_name[$i]
        </td>
		<!-- 규격 또는 옵션  -->
		<td style='text-align:left;border:1px solid #000000;padding:3px 3px 3px 3px;'>
		...
		<!-- 단 위  -->
		<td style='text-align:center;border:1px solid #000000;padding:3px 3px 3px 3px;'>
			$it_unit[$i]
		...
		<!-- 단 가  -->
        <td style='text-align:right;border:1px solid #000000;padding:3px 3px 3px 3px;'>
           $unit_cost[$i]
        </td>
		<!-- 소 계  -->
        <td style='text-align:right;border:1px solid #000000;padding:3px 3px 3px 3px;'>
		...
		<!-- 세 액  -->
        <td style='width:7%;text-align: right;border:1px solid #000000;padding:3px 3px 3px 3px;'>
            $it_sumPrice_tax[$i]
        </td>
    </tr>
